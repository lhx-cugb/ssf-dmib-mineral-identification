...
# 构建一个硬度编号的字典
hardness_dict = {'Agate': [3, 1, -1], 'Albite': [3, 1, -1],
                 'Almandine': [3, 1, -1], 'Anglesite': [2, 1, -1],
                 'Azurite': [2, 1, -1], 'Beryl': [3, 1, -1],
                 'Cassiterite': [3, 1, -1], 'Chalcopyrite': [2, 0, -1],
                 'Cinnabar': [1, 0, -1], 'Copper': [2, 0, -1], 'Demantoid': [3, 1, -1],
                 'Diopside': [3, 1, -1], 'Elbaite': [3, 1, -1], 'Epidote': [3, 1, -1],
                 'Fluorite': [2, 1, -1], 'Galena': [1, 0, -1], 'Gold': [2, 0, -1],
                 'Halite': [1, 1, -1], 'Hematite': [3, 0, -1], 'Magnetite': [3, 0, -1],
                 'Malachite': [2, 1, -1], 'Marcasite': [3, 0, -1], 'Opal': [3, 1, -1],
                 'Orpiment': [1, 1, -1], 'Pyrite': [3, 0, -1], 'Quartz': [3, 1, -1],
                 'Rhodochrosite': [2, 1, -1], 'Ruby': [3, 1, -1], 'Sapphire': [3, 1, -1],
                 'Schorl': [3, 1, -1], 'Sphalerite': [2, 1, -1], 'Stibnite': [1, 0, -1],
                 'Sulphur': [1, 1, -1], 'Topaz': [3, 1, -1], 'Torbernite': [1, 1, -1],
                 'Wulfenite': [2, 1, -1]}
...
model_weight = "SSF_Net_v6_2mo_12_epoch_9_ckt.pth"
...
model_name = "SSF_Net_v7_error_found_2mo_12_v4_v3_e60"
...
optimizer = SGD([
    ...
    {'params': model.classifier_2mo_12_error.parameters()},
...
def evaluate(model, criterion):
    ...
    with torch.no_grad():
        ...
        for image, label, hardness_token in my_dataloader_val:
            ...
            pred, pred_info = model(image, hardness_token, 11)
...
if __name__ == '__main__':
    ...
    for epoch in range(epoches):
        ...
        for image, label, hardness_token in my_dataloader:
            ...
            student_output, student_output_info = model(image, corrupted_hardness_token, 11)
