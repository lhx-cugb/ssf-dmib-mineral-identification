...
# 构建一个硬度编号的字典
hardness_dict = {'Agate': [3, -1, 0], 'Albite': [3, -1, 0], 'Almandine': [3, -1, 0],
                        'Anglesite': [2, -1, 1], 'Azurite': [2, -1, 1], 'Beryl': [3, -1, 0],
                        'Cassiterite': [3, -1, 0], 'Chalcopyrite': [2, -1, 1], 'Cinnabar': [1, -1, 1],
                        'Copper': [2, -1, 1], 'Demantoid': [3, -1, 0], 'Diopside': [3, -1, 0],
                        'Elbaite': [3, -1, 0], 'Epidote': [3, -1, 1], 'Fluorite': [2, -1, 0],
                        'Galena': [1, -1, 1], 'Gold': [2, -1, 1], 'Halite': [1, -1, 0],
                        'Hematite': [3, -1, 1], 'Magnetite': [3, -1, 1], 'Malachite': [2, -1, 1],
                        'Marcasite': [3, -1, 1], 'Opal': [3, -1, 0], 'Orpiment': [1, -1, 1],
                        'Pyrite': [3, -1, 1], 'Quartz': [3, -1, 0], 'Rhodochrosite': [2, -1, 0],
                        'Ruby': [3, -1, 0], 'Sapphire': [3, -1, 0], 'Schorl': [3, -1, 1],
                        'Sphalerite': [2, -1, 1], 'Stibnite': [1, -1, 1], 'Sulphur': [1, -1, 1],
                        'Topaz': [3, -1, 0], 'Torbernite': [1, -1, 1], 'Wulfenite': [2, -1, 0]}
...
model_weight = "SSF_Net_v6_2mo_13_epoch_14_ckt.pth"
...
model_name = "SSF_Net_v7_error_found_2mo_13_v4_v3_e60"
...
optimizer = SGD([
    ...
    {'params': model.classifier_2mo_13_error.parameters()},
...
def evaluate(model, criterion):
    ...
    with torch.no_grad():
        ...
        for image, label, hardness_token in my_dataloader_val:
            ...
            pred, pred_info = model(image, hardness_token, 12)
...
if __name__ == '__main__':
    ...
    for epoch in range(epoches):
        ...
        for image, label, hardness_token in my_dataloader:
            ...
            student_output, student_output_info = model(image, corrupted_hardness_token, 12)
